             ...
             <ul>
                ...
                <li class="current"><a href="#"><img src="/SSHProject/img/icons/menu/layout.png" alt="" />Options On Risk</a>
                    <ul>
                         ...
                         <li class="current"><a href="PlanCreate.jsp">Create Plan</a></li>
...
<div class="bloc">
    <div class="title">创建风险管理计划</div>
    <div class="content">
      <s:form action="planaction">
        <div class="input">
            <label for="input1">计划名</label>
            <input type="text" name = "plan.name" id="input1"/>
        </div>
        <div class="submit">
